...
import { submitCallbackRequest } from "@/lib/contact-request";
import {
  PHONE_MASK_PREFIX,
  applyPhoneMask,
  formatRuPhoneMask,
...
const inputClassName =
  "w-full rounded-xl border bg-white/[0.05] px-3.5 py-2.5 text-[1rem] text-white outline-none transition placeholder:text-[#6d82a8] focus:ring-2 border-white/10 focus:border-[#66B3FF]/55 focus:ring-[#66B3FF]/25";
        ...
        <motion.div className="fixed inset-0 z-[300] flex items-end justify-center p-4 sm:items-center sm:p-6">
          ...
          <motion.div
            ...
            className={cn(
              ...
              submitted ? "max-w-[22rem]" : "max-w-[24rem]",
                  ...
                  >
                    <div className="mb-6 flex items-start justify-between gap-3">
                      <div className="min-w-0 flex-1">
                        ...
                        <p className="mt-2 text-[0.98rem] leading-relaxed text-[#9cb0d4]">
                        ...
                        <input
                          ...
                          onKeyDown={(event) => {
                            ...
                            if (charBefore && !/\d/.test(charBefore)) {
                              event.preventDefault();
                              setPhone(
                                digits.length === 1 ? "" : formatRuPhoneMask(digits.slice(0, -1)),
                              );
                            }
                          }}
                          onBlur={() => {
